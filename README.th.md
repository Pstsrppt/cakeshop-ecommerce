...
ดูเพิ่มเติมที่ [`TROUBLESHOOTING.md`](TROUBLESHOOTING.md) — ปัญหาจริงที่เจอระหว่างพัฒนา (ปัญหา auth ของ MySQL, บั๊กที่ config เขียนทับ connection string แบบไม่รู้ตัว, ข้อมูลเสียหายจาก encoding, เอกสารเพี้ยนไปจากโค้ดจริง) พร้อมวิธีวินิจฉัยและแก้ไขแต่ละจุด
