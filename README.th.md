...
- เลือกดูสินค้าตามหมวดหมู่ พร้อมแสดงสถานะสินค้าหมด
...
เอกสารการวิเคราะห์ระบบอยู่ในโฟลเดอร์ [`docs/`](docs/):

- **Context Diagram (DFD Level 0)** — ภาพรวมระบบพร้อม external entities และ data stores
- **DFD Level 1** — แยกย่อยกระบวนการของ ลูกค้า (9), พนักงาน (6), และผู้ดูแลระบบ (4)
- **Flowchart** — สมัครสมาชิก/ล็อกอิน, การซื้อสินค้าและชำระเงิน, POS และสต๊อกสินค้า, การทำงานของผู้ดูแลระบบ

> _อยู่ระหว่างเตรียมไฟล์ไดอะแกรม — เร็วๆ นี้_
